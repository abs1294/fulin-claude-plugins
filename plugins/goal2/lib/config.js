...
//   goal.grill                       propose 前先 grill（true，預設）：把任務當設計樹，一輪問完當下能問的全部分岔（每題附建議答案），
//                                    問到沒有任何決策是默默假設的才 propose；false = 跳過直接起。事實層（項目清單落檔）不受此開關影響、一律做。
...
const VALIDATORS = {
  ...
  'goal.grill': (v) => (typeof v === 'boolean' ? null : '需為 true 或 false（false = 不問直接起）'),
