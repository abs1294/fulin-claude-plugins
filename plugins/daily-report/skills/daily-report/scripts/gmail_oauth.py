...
def cmd_send(args):
    ...
    raw = build_message(plan.md, plan.subject,
                        {"email": cfg.get("from_email", ""), "name": cfg.get("from_name", "")},
                        plan.recipients, plan.cc, html)
    req = urllib.request.Request(
